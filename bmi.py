...
def calculate_bmi():
    ...
    output_label=Label(result_frame,text=name+", Your BMI is "+ str(bmi)+" and "+msg , bg = "lightcyan", font=("Calibri", 12), width=42)
    output_label.place(x=20,y=14)
    output_label.pack()
...
calculate_button.place(x=20, y=220)
